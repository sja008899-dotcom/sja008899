...
var JWT_SECRET = process.env.JWT_SECRET || process.env.SESSION_SECRET || "golarys_super_secret_key_2026_persian_flowers";
  ...
  app.post("/api/orders", optionalUser, (req, res) => {
    try {
      ...
      const newOrder = {
        ...
        status: paymentMethod === "shaparak" ? "pending_payment" : "paid",
...
\u0631\u0647\u06AF\u06CC\u0631\u06CC \u0622\u0646\u0644\u0627\u06CC\u0646: golarys.ir`
  ...
  app.get("/api/orders", (req, res) => {
    ...
    const payload = token ? createToken : null;
    const authPayload = token ? req.admin || requireAdmin : null;
